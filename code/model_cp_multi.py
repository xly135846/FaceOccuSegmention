...
def mobilenet(channels=[12,12,12,12,24,24,24,24,36,36,36,36,
                        48,48,48,128], t=1):
    inputs_1 = Input((128, 128, 3))
    inputs_2 = Input((128, 128, 1))
    inputs = Concatenate()([inputs_1, inputs_2])

    conv_0 = Conv2D(channels[0], 
                    (1,1),
                    strides=(1,1),
                    padding='same',
    ...
    conv_0_ac = Activation(tf.nn.relu6)(conv_0_bn)
    ...
    block_8_conv_1 = Conv2D(channels[15],
                            ...
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_8_conv_1')(block_8_concatenate)
    block_8_conv_1_bn = BatchNormalization()(block_8_conv_1)
    block_8_conv_1_ac = Activation(tf.nn.relu6)(block_8_conv_1_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_8_deconv_1 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_8_deconv_1')(block_8_conv_1_ac)
    block_8_deconv_1_bn = BatchNormalization()(block_8_deconv_1)
    block_8_deconv_1_ac = Activation(tf.nn.relu6)(block_8_deconv_1_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_8_conv_2 = Conv2D(channels[15],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_8_conv_2')(block_8_deconv_1_ac)
    block_8_conv_2_bn = BatchNormalization()(block_8_conv_2)
    block_8_conv_2_ac = Activation(tf.nn.relu6)(block_8_conv_2_bn)
    ...
    block_8_conv_3 = Conv2D(channels[16],
                            ...
                            name='block_8_conv_3')(block_8_conv_2_ac)
    block_8_conv_3_bn = BatchNormalization()(block_8_conv_3)
    block_8_conv_3_ac = Activation(tf.nn.relu6)(block_8_conv_3_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_8_deconv_2 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_8_deconv_2')(block_8_conv_3_ac)
    block_8_deconv_2_bn = BatchNormalization()(block_8_deconv_2)
    block_8_deconv_2_ac = Activation(tf.nn.relu6)(block_8_deconv_2_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_8_conv_4 = Conv2D(channels[16],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_8_conv_4')(block_8_deconv_2_ac)
    block_8_conv_4_bn = BatchNormalization()(block_8_conv_4)
    block_8_conv_4_ac = Activation(tf.nn.relu6)(block_8_conv_4_bn)

    block_9_upsampling_1 = UpSampling2D((2, 2),interpolation='bilinear')(block_8_conv_4_ac)
    ...
    block_9_conv_1 = Conv2D(channels[17],
                            ...
                            name='block_9_conv_1')(block_9_concatenate)
    block_9_conv_1_bn = BatchNormalization()(block_9_conv_1)
    block_9_conv_1_ac = Activation(tf.nn.relu6)(block_9_conv_1_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_9_deconv_1 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_9_deconv_1')(block_9_conv_1_ac)
    block_9_deconv_1_bn = BatchNormalization()(block_9_deconv_1)
    block_9_deconv_1_ac = Activation(tf.nn.relu6)(block_9_deconv_1_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_9_conv_2 = Conv2D(channels[17],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_9_conv_2')(block_9_deconv_1_ac)
    block_9_conv_2_bn = BatchNormalization()(block_9_conv_2)
    block_9_conv_2_ac = Activation(tf.nn.relu6)(block_9_conv_2_bn)

    block_9_conv_3 = Conv2D(channels[18],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_9_conv_3')(block_9_conv_2_ac)
    block_9_conv_3_bn = BatchNormalization()(block_9_conv_3)
    block_9_conv_3_ac = Activation(tf.nn.relu6)(block_9_conv_3_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_9_deconv_2 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_9_deconv_2')(block_9_conv_3_ac)
    block_9_deconv_2_bn = BatchNormalization()(block_9_deconv_2)
    block_9_deconv_2_ac = Activation(tf.nn.relu6)(block_9_deconv_2_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_9_conv_4 = Conv2D(channels[18],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_9_conv_4')(block_9_deconv_2_ac)
    block_9_conv_4_bn = BatchNormalization()(block_9_conv_4)
    block_9_conv_4_ac = Activation(tf.nn.relu6)(block_9_conv_4_bn)

    block_10_upsampling_1 = UpSampling2D((2, 2),interpolation='bilinear')(block_9_conv_4_ac)
    ...
    block_10_conv_1 = Conv2D(channels[19],
                            ...
                            name='block_10_conv_1')(block_10_concatenate)
    block_10_conv_1_bn = BatchNormalization()(block_10_conv_1)
    block_10_conv_1_ac = Activation(tf.nn.relu6)(block_10_conv_1_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_10_deconv_1 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_10_deconv_1')(block_10_conv_1_ac)
    block_10_deconv_1_bn = BatchNormalization()(block_10_deconv_1)
    block_10_deconv_1_ac = Activation(tf.nn.relu6)(block_10_deconv_1_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_10_conv_2 = Conv2D(channels[19],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_10_conv_2')(block_10_deconv_1_ac)
    block_10_conv_2_bn = BatchNormalization()(block_10_conv_2)
    block_10_conv_2_ac = Activation(tf.nn.relu6)(block_10_conv_2_bn)

    block_10_conv_3 = Conv2D(channels[20],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_10_conv_3')(block_10_conv_2_ac)
    block_10_conv_3_bn = BatchNormalization()(block_10_conv_3)
    block_10_conv_3_ac = Activation(tf.nn.relu6)(block_10_conv_3_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_10_deconv_2 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_10_deconv_2')(block_10_conv_3_ac)
    block_10_deconv_2_bn = BatchNormalization()(block_10_deconv_2)
    block_10_deconv_2_ac = Activation(tf.nn.relu6)(block_10_deconv_2_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_10_conv_4 = Conv2D(channels[20],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_10_conv_4')(block_10_deconv_2_ac)
    block_10_conv_4_bn = BatchNormalization()(block_10_conv_4)
    block_10_conv_4_ac = Activation(tf.nn.relu6)(block_10_conv_4_bn)

    block_11_upsampling_1 = UpSampling2D((2, 2),interpolation='bilinear')(block_10_conv_4_ac)
    ##print("111",block_11_upsampling_1.shape)
    block_11_concatenate = Concatenate()([block_11_upsampling_1, conv_0_ac])
    ...
    block_11_conv_1 = Conv2D(channels[21],
                            ...
                            name='block_11_conv_1')(block_11_concatenate)
    block_11_conv_1_bn = BatchNormalization()(block_11_conv_1)
    block_11_conv_1_ac = Activation(tf.nn.relu6)(block_11_conv_1_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_11_deconv_1 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_11_deconv_1')(block_11_conv_1_ac)
    block_11_deconv_1_bn = BatchNormalization()(block_11_deconv_1)
    block_11_deconv_1_ac = Activation(tf.nn.relu6)(block_11_deconv_1_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_11_conv_2 = Conv2D(channels[21],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_11_conv_2')(block_11_deconv_1_ac)
    block_11_conv_2_bn = BatchNormalization()(block_11_conv_2)
    block_11_conv_2_ac = Activation(tf.nn.relu6)(block_11_conv_2_bn)

    block_11_conv_3 = Conv2D(channels[22],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_11_conv_3')(block_11_conv_2_ac)
    block_11_conv_3_bn = BatchNormalization()(block_11_conv_3)
    block_11_conv_3_ac = Activation(tf.nn.relu6)(block_11_conv_3_bn)
    ##print("333",block_7_conv_1_ac.shape)
    block_11_deconv_2 = DepthwiseConv2D((3,3),
                                        strides=(1,1),
                                        depth_multiplier=1,
                                        padding='same',
                                        #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                                        name='block_11_deconv_2')(block_11_conv_3_ac)
    block_11_deconv_2_bn = BatchNormalization()(block_11_deconv_2)
    block_11_deconv_2_ac = Activation(tf.nn.relu6)(block_11_deconv_2_bn)
    ##print("444",block_7_deconv_1_ac.shape)
    block_11_conv_4 = Conv2D(channels[22],
                            (1,1),
                            strides=(1,1),
                            padding='same',
                            #kernel_regularizer=tf.keras.regularizers.l1(1e-4),
                            name='block_11_conv_4')(block_11_deconv_2_ac)
    block_11_conv_4_bn = BatchNormalization()(block_11_conv_4)
    block_11_conv_4_ac = Activation(tf.nn.relu6)(block_11_conv_4_bn)

    output = Conv2D(2, (1, 1), padding="same")(block_11_conv_4_ac)
